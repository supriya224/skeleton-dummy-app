...
function App() {
        ...
        return (
          <div className="card">
            <div className="cardImage">
              <img src="https://cdn.pixabay.com/photo/2015/04/19/08/32/marguerite-729510_640.jpg" alt="logo" width="80px" height="80px" />
              <div>The Blog App</div>
            </div>
  ...
  return (
    <div className="App">
      <h1>React Skeleton dummy loading project</h1>
      <div>
